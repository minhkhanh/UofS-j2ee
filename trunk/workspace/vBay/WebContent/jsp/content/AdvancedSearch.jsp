...
<div class="contentframe ui-widget-content ui-corner-all">
  <div class="captionbox ui-widget-header ui-corner-top">TÌM KIẾM NÂNG CAO</div>
  <div class="content">
    <form id="formChiTietSP" name="formChiTietSP" action="Search.vby" method="GET">
      <br />
      <table>
        <tr>
          <td><label for="khoaTimKiem">Khóa tìm kiếm: </label></td>
          <td><input type="text" name="khoaTimKiem" style="width: 240px;"></td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="2">Từ <select name="giaNhoNhat" style="width: 90px;">
        ...
        <tr>
          <td><input type="submit" name="submitTimNangCao" value="Tìm kiếm"></td>
        </tr>
      </table>
    </form>
  </div>
