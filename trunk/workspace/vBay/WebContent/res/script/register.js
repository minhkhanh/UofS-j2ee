...
function checkValidationReg() {
	...
	var x=document.forms["frmDangKy"]["ngaySinh"].value;
	if (x==null || x.length<=4) {
		document.forms["frmDangKy"]["ngaySinh"].className = 'imgCheckError';
		result = false;
	} else {
		document.forms["frmDangKy"]["ngaySinh"].className = 'imgCheckOk';
	}
	
	var x=document.forms["frmDangKy"]["noiSinh"].value;
	if (x==null || x.length<=4) {
		document.forms["frmDangKy"]["noiSinh"].className = 'imgCheckError';
		result = false;
	} else {
		document.forms["frmDangKy"]["noiSinh"].className = 'imgCheckOk';
	}
	
	var x=document.forms["frmDangKy"]["maTheTinDung"].value;
	if (x==null || x.length<=4) {
		document.forms["frmDangKy"]["maTheTinDung"].className = 'imgCheckError';
		result = false;
	} else {
		document.forms["frmDangKy"]["maTheTinDung"].className = 'imgCheckOk';
	}
