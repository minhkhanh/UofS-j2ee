        ...
        <div class="thumbpitem_img_con">
          <div class="thumbpitem_img_con_inner">
            <div class="thumbpitem_img">
              <a href="<c:url value="/Product.vby?maSanPham=${sp.maSanPham }"/>"><img
                width="118px" height="108px"
                src="<c:url value='${listImageNewAuctions.get(i.index)}'/>"> </a>
            </div>
          </div>
        </div>
        <div style="float: left; margin-right: 5px; font-size: 9px; color: #cccccc">
          <em>Price:</em>
        </div>
  ...
  <div class="content" style="display: table;">
    <c:forEach var="ct" items="${recentlySoldProducts}" varStatus="i">
      <div class="thumbpitem">
        ...
        <div style="float: left; margin-right: 5px; font-size: 16px; color: #f92c0a">
          <b><em>Selled:</em></b>
        </div>
        <div style="margin-right: 2px; margin-bottom: 10px; font-size: 16px; color: yellow;">
