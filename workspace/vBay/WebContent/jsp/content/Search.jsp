...
<div class="contentframe ui-widget-content ui-corner-all">
  <div class="captionbox ui-widget-header ui-corner-top">KẾT QUẢ TÌM KIẾM</div>
  <c:choose>
        ...
        <form name="formThongSoHienThi" method="get" action="#">
          <table width="100%" cellpadding="5" cellspacing="0">
            ...
            <tr>
              ...
              <td align="right" width="50%"><label for="soSPTrenTrang">Số sản phẩm trên
                  trang </label> <select name="soSPTrenTrang" style="height: 25px; width: 53px;"
                  onchange="submit()">
            ...
            <tr>
              <td><input type="hidden" name="maLoaiSanPham" value="${param.maLoaiSanPham}" />
                <input type="hidden" name="khoaTimKiem" value="${param.khoaTimKiem}" /> <input
                  type="hidden" name="trangHienThi" value="${trangHienThi}" /> <input type="hidden"
                  name="giaNhoNhat" value="${param.giaNhoNhat}" /> <input type="hidden"
                  name="giaLonNhat" value="${param.giaLonNhat}" /> <input type="hidden"
                  name="thoiGian" value="${param.thoiGian }" /></td>
            </tr>
          </table>
        </form>
            ...
            <tr>
              <td width="20%"><a
                href="<c:url value="Product.vby?maSanPham=${sp.maSanPham }" />"><img
                  width="75px" height="75px" src="<c:url value='${dsHinhAnh.get(status.index)}'/>">
              </a></td>
              <c:choose>
