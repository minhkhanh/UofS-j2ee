...
<link href="<c:url value='/res/style/main.css'/>" rel="stylesheet"
	type="text/css" />
<link href="<c:url value='/res/style/sidewrap.css'/>" rel="stylesheet"
	type="text/css" />
<link href="<c:url value='/res/style/mainwrap.css'/>" rel="stylesheet"
	type="text/css" />
<link href="<c:url value='/res/style/header.css'/>" rel="stylesheet"
	type="text/css" />
<link href="<c:url value='/res/style/userpanel.css'/>" rel="stylesheet"
	type="text/css" />
<link href="<c:url value='/res/style/mainmenu.css'/>" rel="stylesheet"
	type="text/css" />
<link href="<c:url value='/res/style/timepicker.css'/>" rel="stylesheet"
	type="text/css" />
<link href="<c:url value='/res/style/slide.css'/>" rel="stylesheet"
	type="text/css" />
<link
	href="<c:url value='/res/jquery-ui/trontastic/jquery-ui-1.8.16.custom.css'/>"
	rel="stylesheet" type="text/css" />
<link href="<c:url value='/res/countdown/jquery.countdown.custom.css'/>"
	rel="stylesheet" type="text/css" />
...
<script
	src="<c:url value='/res/jquery-ui/trontastic/jquery-ui-1.8.16.custom.min.js' />"></script>
<script
	src="<c:url value='/res/script/jquery-ui-timepicker-addon.js' />"></script>

<link href="<c:url value='/res/ajaxupload/fileuploader.css'/>"
	rel="stylesheet" type="text/css" />
<script src="<c:url value='/res/script/main.js' />"
	type="text/javascript"></script>
<script src="<c:url value='/res/script/jquery.form-2.77.js' />"
	type="text/javascript"></script>
<script src="<c:url value='/res/script/register.js' />"
	type="text/javascript"></script>
</head>
<body>
  <script>
